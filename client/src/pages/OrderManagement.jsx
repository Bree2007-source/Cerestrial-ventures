  ...
  return (
    <div style={{ padding: '24px', maxWidth: 1300, margin: '0 auto', fontFamily: 'sans-serif', color: '#334155' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12, marginBottom: 20 }}>
        ...
        <button onClick={fetchOrders} style={{ padding: '9px 18px', borderRadius: 8, border: '1px solid #e2e8f0', backgroundColor: 'white', color: '#334155', cursor: 'pointer', fontWeight: 600, fontSize: 13 }}>🔄 Refresh</button>
      </div>
      ...
      <div style={{ backgroundColor: 'white', border: '1px solid #e2e8f0', borderRadius: 10, overflow: 'hidden' }}>
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
            ...
            <tbody>
              {visible.length === 0 ? (
                <tr><td colSpan="9" style={{ padding: 40, textAlign: 'center', color: '#94a3b8' }}>{orders.length === 0 ? 'No orders yet.' : 'No orders match your search.'}</td></tr>
              ) : visible.map(order => {
