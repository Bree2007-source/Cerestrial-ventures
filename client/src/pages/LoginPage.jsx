...
const LoginPage = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'sans-serif' }}>
      ...
      {/* ── LEFT PANEL ── */}
      <div style={{
        flex: 1, background: 'linear-gradient(160deg, #f0fdf4 0%, #dcfce7 60%, #bbf7d0 100%)',
        ...
        <div style={{
          width: 240, height: 200, borderRadius: 24,
      ...
      <div style={{
        ...
        minHeight: '100vh', boxSizing: 'border-box', overflowY: 'auto',
      }}>
          ...
          <>
            ...
            <form onSubmit={handleLogin}>
              <div style={{ marginBottom: 18 }}>
                <label style={{ fontSize: 13, fontWeight: 600, color: '#374151', display: 'block', marginBottom: 7 }}>Email or Phone Number</label>
                <input
                  type="email" required
