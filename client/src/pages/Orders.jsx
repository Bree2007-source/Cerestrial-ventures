...
const Orders = () => {
  ...
  return (
    <div style={{
      padding: 20, maxWidth: 900,
      margin: '0 auto', fontFamily: 'sans-serif', paddingBottom: 80
    }}>
      <h2 style={{ color: '#1e293b', borderBottom: '2px solid #15803d', paddingBottom: 10 }}>
        📦 My Orders
      </h2>
        ...
        return (
          <div key={order._id} style={{
            ...
            <div style={{
              ...
              backgroundColor: '#f8fafc', padding: 15,
              ...
              <div>
                ...
                <strong style={{ color: '#15803d', display: 'block' }}>
                  KSh {order.totalAmount || order.totalPrice}
                </strong>
              </div>
              <div>
            ...
            <div style={{
              ...
              backgroundColor: '#f1f5f9', padding: 10,
            ...
            <div style={{ position: 'relative', padding: '10px 0' }}>
              <div style={{
                position: 'absolute', top: 25, left: '5%', right: '5%',
                height: 3, backgroundColor: '#e2e8f0', zIndex: 1
              }} />
              <div style={{
                position: 'absolute', top: 25, left: '5%',
                width: `${(Math.max(currentStepIndex, 0) / (statusSteps.length - 1)) * 90}%`,
                height: 3, backgroundColor: '#15803d',
